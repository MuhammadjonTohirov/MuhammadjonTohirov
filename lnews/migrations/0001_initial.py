# Generated by Django 3.2.3 on 2021-05-27 10:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.TextField(default='Default title', help_text='Category title', verbose_name='Category name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='lnews.basemodel')),
                ('title', models.TextField(verbose_name='Headline')),
                ('category', models.ManyToManyField(to='lnews.NewsCategory')),
            ],
            bases=('lnews.basemodel',),
        ),
    ]
